document.addEventListener('DOMContentLoaded', function() {
    ...
    function createStockChart() {
        ...
        toolTip.style = `width: ${toolTipWidth}px; position: absolute; display: none; padding: 8px; box-sizing: border-box; font-size: 12px; text-align: center; z-index: 1000; top: 20px; left: 12px; pointer-events: none; border-radius: 20px; border-bottom: none; font-family: 'Open Sans', sans-serif; -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale;`;
        ...
        magnifierOverlay.style = `width: ${toolTipWidth}px; position: absolute; display: none; height: 95%; background: rgba(255, 255, 255, 0.1); box-shadow: 0px 0px 10px 0px rgba(255, 255, 255, 0.5); border-radius: 20px; pointer-events: none; z-index: 998; top: 2.5%;`;
        container.appendChild(magnifierOverlay);

        // Create a gradient box for better readability without bottom glow
        const gradientBox = document.createElement('div');
        gradientBox.style = `width: 100%; height: 100%; position: absolute; top: 0; left: 0; background: linear-gradient(to bottom, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0)); pointer-events: none; z-index: -1; border-radius: 20px;`;
